...
from src.modules.data_management.coordinator import system_coordinator
...
def handle_data_operations(args):
    ...
    try:
        from src.modules.data_management.data_center.download import main as download_main
        from src.modules.data_management.data_center.data_processor import process_all_strategies, get_processing_status
...
def print_system_status():
    ...
    try:
        from src.modules.data_management.data_center.data_processor import get_processing_status
...
def run_single_strategy(strategy_name):
    ...
    try:
        from src.modules.portfolio.backtesting.engine import backtest_engine
