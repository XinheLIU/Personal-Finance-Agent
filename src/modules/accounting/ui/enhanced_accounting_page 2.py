...
def show_enhanced_accounting_page():
    ...
    try:
        ...
        from src.modules.accounting.core.cash_flow import generate_cash_flow_statement
        from src.modules.accounting.core.models import Transaction
        from src.modules.accounting.core.io import TransactionProcessor
        from src.modules.accounting.core.models import CategoryMapper
        
        # Sample data functions (simplified)
        ...
        def get_csv_format_template():
            return "Date,Description,Amount,Category,Account"
            
        def get_sample_data_summary():
            return {"transaction_count": 0, "months_covered": 0}
            
        def get_all_categories():
            mapper = CategoryMapper()
            return list(mapper.expense_categories.keys())
